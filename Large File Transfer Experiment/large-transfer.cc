...
NS_LOG_COMPONENT_DEFINE("LargeFileTcpVsUdp");
...
main(int argc, char* argv[])
{
    ...
    uint32_t largeTransferBytes = 2000000;
    ...
    tcpSender.SetAttribute("MaxBytes", UintegerValue(largeTransferBytes));
    ...
    udpSender.SetAttribute("MaxBytes", UintegerValue(largeTransferBytes));

    InetSocketAddress udpRemote(interfaces12u.GetAddress(1), udpPort);
    ...
    csvFile.open("large-file-transfer-output.csv");
