...
NS_LOG_COMPONENT_DEFINE("HighCongestionTcpVsUdp");
...
int main(int argc, char* argv[])
{
    ...
    tcpSender.SetAttribute("DataRate", StringValue("2.5Mbps"));
    ...
    udpSender.SetAttribute("DataRate", StringValue("2.5Mbps"));
    ...
    csvFile.open("high-congestion-output.csv");
