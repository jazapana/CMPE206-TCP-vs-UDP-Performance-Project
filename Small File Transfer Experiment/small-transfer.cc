...
NS_LOG_COMPONENT_DEFINE("SmallFileTcpVsUdp");
...
main(int argc, char* argv[])
{
    ...
    uint32_t smallTransferBytes = 10000;
    ...
    tcpSender.SetAttribute("MaxBytes", UintegerValue(smallTransferBytes));
    ...
    udpSender.SetAttribute("MaxBytes", UintegerValue(smallTransferBytes));
    ...
    csvFile.open("small-file-transfer-output.csv");
